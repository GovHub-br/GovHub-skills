...
fixa 210×297mm, `@page { margin: 0 }`). Herdado da skill do Gov Hub (validado lá em agosto de 2026 e revisto em
2026-09-18; ainda não validado em peça do Lab Livre). São duas páginas de **abertura** (front matter), sempre juntas, sempre
...
<div class="gh-page">
  ...
  <div class="gh-footer">
    <span class="gh-footer__text"><span class="gh-footer__page">2</span>Nome curto do documento &middot; Nome curto do projeto/frente &middot; Lab Livre &middot; UnB</span>
...
<div class="gh-page">
  ...
  <div class="gh-footer-bar"></div>
  <div class="gh-footer">
    <span class="gh-footer__text"><span class="gh-footer__page">3</span>Nome curto do documento &middot; Nome curto do projeto/frente &middot; Lab Livre &middot; UnB</span>
    <img class="gh-footer__logo" alt="" src="logo/borboleta-blue.svg">
  </div>
</div>
```
