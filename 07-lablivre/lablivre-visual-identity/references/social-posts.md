# Posts e carrossel Lab Livre: as 5 estruturas de quadro (código exato validado)

Estruturas de quadro para Instagram/LinkedIn (feed retrato `1080×1350`),
herdadas da skill do Gov Hub (validadas lá com o usuário no carrossel
"Dados públicos, conectados", 2026-09-16; ainda não validadas em peça do
Lab Livre). Nos textos, "navy" = azul profundo `#080056`, "magenta" =
rosa-choque `#E52E70`, "rosa" = laranja `#F46B2F`, "pêssego" = rosa claro.
Atenção ao laranja: texto branco sobre ele só em tamanho grande e bold
(contraste ~3:1, ver `palette.md`). Cada quadro é **um `div.gh-post` de tamanho fixo** com uma
...
<div class="gh-post gh-post--navy" lang="pt-BR">
  ...
  <img src="logo/lab-livre-white.svg" alt="Lab Livre" style="position:absolute; left:88px; top:96px; height:80px; width:auto;">
...
(`lab-livre-blue.svg`, 44px) + "Arraste".
...
<div class="gh-post gh-post--peach" lang="pt-BR">
  ...
  <div class="gh-post__bottom">
    <div><img src="logo/lab-livre-blue.svg" alt="Lab Livre"></div>
    <div><span class="gh-post__hint">Arraste para o lado</span><svg class="gh-arrow" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"></path><path d="M13 6l6 6-6 6"></path></svg></div>
  </div>
</div>
```
...
<div style="display:flex; align-items:stretch; gap:20px; margin-top:8px;">
  ...
  <div class="gh-card" style="display:flex; flex-direction:column; align-items:center; justify-content:center; gap:18px; padding:32px 20px; flex:1; min-height:250px; box-sizing:border-box; background:var(--primary-purple);">
    <img src="logo/borboleta-white.svg" alt="" style="height:96px; width:auto;">
...
("Uma iniciativa de" + logos dos parceiros: UnB sempre, Gov Hub se for
projeto Gov Hub; ordem e versões em
...
<div class="gh-post gh-post--navy" lang="pt-BR">
  ...
  <div style="position:absolute; left:88px; right:88px; top:1000px; display:flex; flex-direction:column; align-items:center; gap:28px;">
    ...
    <div style="display:flex; align-items:center; justify-content:center; gap:48px;">
      ...
      <img src="logo/parceiros/govhub-white.svg" alt="Gov Hub" style="height:60px; width:auto;">
    </div>
  </div>
</div>
```
...
| Erro | Correção |
|---|---|
| Paleta antiga (`#7A34F3` + laranja) e Inter, por ler a cópia desatualizada da skill | Conferir que a skill carregada é a do repo (`01-lablivre/lablivre-visual-identity`), com `#7023E8`, rosa, navy e Reddit Sans + Oswald. |
